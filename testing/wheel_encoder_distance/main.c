...
bool encoderPrintCallback(struct repeating_timer *t)
{
    if (test_active)
    {
        printf("leftRPM:%0.2f, leftDist:%0.2f, leftAccul:%0.2f, leftNotchCount:%d\n", leftEncoderSpeed, leftTotalDistance, left_accul, leftNotchCount);
        printf("rightRPM:%0.2f, rightDist:%0.2f, rightAccul:%0.2f, leftNotchCount:%d\n", rightEncoderSpeed, rightTotalDistance, right_accul, rightNotchCount);
    }
    return true;
}
